...
var freshman: [Student]
freshman = students
freshman = freshman.filter {
        $0.year == StudentYear.freshman
}

//for element in freshman{
//    print(element)
//}
...
let studentsGrades = students.map({ $0.grade })
averageGrade = studentsGrades.reduce(0) { $0 + $1 }
